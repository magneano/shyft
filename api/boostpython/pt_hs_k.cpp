    ...
    namespace pt_hs_k {
        ...
        static void parameter_state_response() {
            class_<parameter,bases<>,std::shared_ptr<parameter>>("PTHSKParameter",
                ...
                .def(init<const priestley_taylor::parameter&,const hbv_snow::parameter&,const actual_evapotranspiration::parameter&,const kirchner::parameter&,const precipitation_correction::parameter&,py::optional<glacier_melt::parameter,routing::uhg_parameter,mstack_parameter>>(args("pt","snow","ae","k","p_corr","gm","routing","msp"),"create object with specified parameters"))
