    ...
    namespace pt_ss_k {
        ...
        parameter_state_response() {
            ...
            class_<parameter,bases<>,std::shared_ptr<parameter>>("PTSSKParameter",
                ...
                .def(init<priestley_taylor::parameter,skaugen::parameter,actual_evapotranspiration::parameter,kirchner::parameter,precipitation_correction::parameter, py::optional<glacier_melt::parameter,routing::uhg_parameter,mstack_parameter>>(args("pt","gs","ae","k","p_corr","gm","routing","msp"),"create object with specified parameters"))
        ...
        collectors() {
            ...
            class_<PTSSKAllCollector>("PTSSKAllCollector", "collect all cell response from a run")
                ...
                .def_readonly("avg_charge",&PTSSKAllCollector::charge_m3s,"cell charge [m^3/s] for the timestep")
            ;
            ...
            class_<PTSSKDischargeCollector>("PTSSKDischargeCollector", "collect all cell response from a run")
                ...
                .def_readonly("avg_charge",&PTSSKDischargeCollector::charge_m3s,"cell charge [m^3/s] for the timestep")
                ;
