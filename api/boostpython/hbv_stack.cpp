	...
	namespace hbv_stack {
		...
		static void parameter_state_response() {
			class_<parameter, bases<>, std::shared_ptr<parameter>>("HbvParameter",
				...
				.def(init<const priestley_taylor::parameter&, const hbv_snow::parameter&, const hbv_actual_evapotranspiration::parameter&, const hbv_soil::parameter&, const hbv_tank::parameter&, const precipitation_correction::parameter&, py::optional<glacier_melt::parameter,routing::uhg_parameter,mstack_parameter>>(args("pt", "snow", "ae", "soil", "tank", "p_corr","gm","routing","msp"), "create object with specified parameters"))
