    ...
    namespace pt_hps_k {
        ...
        collectors() {
            ...
            class_<PTHPSKAllCollector>("PTHPSKAllCollector", "collect all cell response from a run")
                ...
                .def_readonly("hps_sca",&PTHPSKAllCollector::snow_sca," hbv snow covered area fraction, sca.. 0..1 - at the end of timestep (state)")
                .def_readonly("hps_swe",&PTHPSKAllCollector::snow_swe,"hbv snow swe, [mm] over the cell sca.. area, - at the end of timestep")
            ...
            class_<PTHPSKDischargeCollector>("PTHPSKDischargeCollector", "collect all cell response from a run")
                ...
                .def_readonly("hps_sca",&PTHPSKDischargeCollector::snow_sca," hbv snow covered area fraction, sca.. 0..1 - at the end of timestep (state)")
                .def_readonly("hps_swe",&PTHPSKDischargeCollector::snow_swe,"hbv snow swe, [mm] over the cell sca.. area, - at the end of timestep")
