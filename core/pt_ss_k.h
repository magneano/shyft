    ...
    namespace pt_ss_k {
        ...
        struct parameter {
            ...
            parameter(const pt_parameter_t& pt,
             ...
             : pt(pt), ss(snow), ae(ae), kirchner(kirchner), p_corr(p_corr),gm(gm),routing(routing),msp{msp} { /* Do nothing */ }
            ...
            double get(size_t i) const {
                switch (i) {
                    ...
                    case 20:return msp.reservoir_direct_response_fraction;
        ...
        struct state {
            ...
            */
            ...
            state scale_snow(const double& snow_storage_area_fraction) const {
                ...
                c.snow.free_water *=snow_storage_area_fraction;// is this reasonable?
                c.snow.num_units =size_t(c.snow.num_units*snow_storage_area_fraction);
                return c;
            }
