    ...
    namespace utility {
        namespace geometry{
            ...
            struct triangle{
                ...
                Point mid_point = std::make_tuple(x,y,z);
                ...
                Point normal = std::make_tuple(normal_x,normal_y,normal_z);
                double slope = atan2(pow(pow(normal_x,2)+pow(normal_y,2),0.5),normal_z);
                double aspect = atan2(normal_y, normal_x);
                double elevation = std::get<2>(mid_point);
