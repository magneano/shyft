...
class TimeSeries(unittest.TestCase):
    ...
    def test_ts_extend_with_points_fail(self):
        ...
        tsp_1_fail = api.TimeSeries(api.TimeAxis([0, 1, 1.5]), [1, 2], api.POINT_INSTANT_VALUE)
        tsp_2_fail = api.TimeSeries(api.TimeAxis([2, 3, 4]), [3, 4], api.POINT_INSTANT_VALUE)
        extend_fail = tsp_1_fail.extend(tsp_2_fail)
        self.assertEquals(len(extend_fail.time_axis), 5)
        tsp_1 = api.TimeSeries(api.TimeAxis([0, 1, 2]), [1, 2], api.POINT_INSTANT_VALUE)
        tsp_2 = api.TimeSeries(api.TimeAxis([2, 3, 4]), [3, 4], api.POINT_INSTANT_VALUE)

        extend = tsp_1.extend(tsp_2)
        self.assertEquals(len(extend.time_axis), 4)
