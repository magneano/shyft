...
TEST_CASE("pt_ss_k_lake_reservoir_response") {
    calendar cal;
    ...
    pt_ss_k::state_collector sc;
    pt_ss_k::all_response_collector rc;
    ...
    pt_ss_k::run<direct_accessor,pt_ss_k::response>(gcd,parameter,tax,0,0,temp,prec,wind_speed,rel_hum,radiation,s0,sc,rc);
    ...
    sc.initialize(tax_state,0,0,cell_area);
    rc.initialize(tax,0,0,cell_area);
    pt_ss_k::run<direct_accessor,pt_ss_k::response>(gcd,parameter,tax,0,0,temp,prec,wind_speed,rel_hum,radiation,s1,sc,rc);
